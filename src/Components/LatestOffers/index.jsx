        ...
        <div className="grid grid-cols-1 gap-5 space-x-1 sm:grid-cols-4 md:grid-cols-2 lg:grid-cols-4 "> 
          <div className="duration-500 transform bg-white rounded-xl hover:translate-y-2"> 
            <div className="flex flex-col p-4">
              ...
              <button onClick={() => setCart(cart + 1)} className="mx-6 px-1.5 h-10 mt-4 text-lg font-medium bg-yellow-500 rounded-md hover:bg-yellow-300 text-black">Comprar</button>
            </div>
          </div>          
          <div className="duration-500 transform bg-white rounded-xl hover:translate-y-2"> 
            <div className="flex flex-col p-4">
              ...
              <button onClick={() => setCart(cart + 1)} className="mx-6 px-1.5 h-10 mt-4 text-lg font-medium text-black bg-yellow-500 rounded-md hover:bg-yellow-300">Comprar</button>
            </div>
          </div> 
          <div className="duration-500 transform bg-white rounded-xl hover:translate-y-2"> 
            <div className="flex flex-col p-4">
