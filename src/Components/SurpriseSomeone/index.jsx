...
const SurpriseSomeone = () => {
  return (
    ...
    <div className="flex items-center max-w-5xl mt-16 mb-8 ml-12 mr-12">
            <img src="/imagenes/regalo.jpg" alt="Zapatillas de regalo" className="float-left object-cover w-1/2 h-[432px] rounded"/>
            <div className="flex flex-col w-1/2 pl-8">
                ...
                <button className="w-40 h-12 mt-5 text-lg bg-yellow-300 border-none rounded text-oscuro ">Comprar Ahora</button>
            </div>
    </div>
    </div>
  );
